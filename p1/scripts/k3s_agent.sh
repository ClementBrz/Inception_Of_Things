...
echo "${B_YELLOW}Executing k3s_agent.sh on $(hostname)${RESET}"
...
if k3s --version;then
    ...
    if export INSTALL_K3S_EXEC="agent --server=https://192.168.56.110:6443 --node-ip=192.168.56.111 --token-file=/vagrant/server-token"; then
